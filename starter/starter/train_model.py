...
slices(model, cat_features, train, encoder, lb, cat_features)
...
filename = os.path.realpath(
    os.path.join(os.path.dirname(__file__), "..", "model", "encoder.pkl")
)
with open(filename, "wb") as file:
    pickle.dump(encoder, file)

filename = os.path.realpath(
    os.path.join(os.path.dirname(__file__), "..", "model", "lb.pkl")
)
with open(filename, "wb") as file:
    pickle.dump(lb, file)
